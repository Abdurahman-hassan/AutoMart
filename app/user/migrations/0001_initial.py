    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('customer', 'Customer'), ('salesman', 'Salesman'), ('delivery', 'Delivery')], default='customer', max_length=50, null=True, verbose_name='User Role')),
